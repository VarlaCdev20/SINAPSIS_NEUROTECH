        ...
        <form method="POST" action="{{ route('users.update',$user->id) }}"
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="name" value="{{ $user->name }}" placeholder="Ej. Carlos"
                ...
                <div>
                    ...
                    <input type="text" name="paterno" value="{{ $user->paterno }}" placeholder="Ej. Méndez"
                ...
                <div>
                    ...
                    <input type="text" name="materno" value="{{ $user->materno }}" placeholder="Ej. Brun"
                ...
                <div>
                    ...
                    <input type="text" name="carnet" value="{{ $user->carnet }}" placeholder="Ej. 1234564"
                ...
                <div>
                    ...
                    <input type="text" name="celular" value="{{ $user->celular}}" placeholder="Ej. 71234567"
                        class="w-full rounded-lg border-gray-300 focus:ring-2 focus:ring-blue-500 px-3 py-2 shadow-sm text-gray-700 placeholder-gray-400 @error('celular') border-red-500 @enderror">
                    @error('celular')
                    <p class="text-red-600 text-xs mt-1"><i class="bi bi-exclamation-circle"></i> {{ $message }}</p>
                    @enderror
                ...
                <div>
                    ...
                    <input type="text" name="ocupacion" value="{{ $user->ocupacion}}" placeholder="Ej. Médico General"
